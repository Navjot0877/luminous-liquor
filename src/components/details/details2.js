...
<div className="picture_side">
    ...
    {check?(
       <button className="cartBut2" value={addLabel} onClick={CartButton}>{addLabel}</button>
       
    ):(
      <button className="cartBut2" value="Add to Cart" onClick={noCart}>Add to Cart</button>
